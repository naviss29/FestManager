...
import { Mission, MissionRequest, CategorieMission } from '../models/mission.model';
...
export class MissionService {
  ...
  lister(evenementId: string, page = 0, size = 20, categorie?: CategorieMission): Observable<PageResponse<Mission>> {
